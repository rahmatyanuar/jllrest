...
if($_SERVER['REQUEST_METHOD']=='GET'){
    ...
    // 	$getQueryKwh = "SELECT a.bill_id, b.bgr_id ,a.report_date,max(a.kwh) FROM `billing_tbl` as a left join bergainser_tbl as b on a.bgr_id = b.id group by a.bill_id, b.bgr_id ,a.report_date";
    //if data inserts successfully
    $getQueryKwh = "CALL kwh.billingProc()";
    $idMeteran = null;
